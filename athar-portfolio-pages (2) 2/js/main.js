...
(function () {
  ...
  $$(".js-cert").forEach((el) => {
    el.addEventListener("click", (e) => {
      ...
      if (d.img) html += '<div class="modal-img"><img src="' + d.img + '" alt="' + d.title + ' certificate" loading="lazy"></div>';
      ...
      if (d.img) html += '<a class="btn magnet" href="' + d.img + '" target="_blank" rel="noopener"><span>Open Full Image ↗</span></a>';
